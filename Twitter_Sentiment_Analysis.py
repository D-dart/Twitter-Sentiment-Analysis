    ...
    def __init__(self):
        ...
        for tweet in self.tweets:
            ...
            if (analysis.sentiment.polarity == 0):  
                neutral += 1
            elif (analysis.sentiment.polarity > 0.0 and analysis.sentiment.polarity <= 0.3):
                positive += 1
            elif (analysis.sentiment.polarity > 0.3 and analysis.sentiment.polarity <= 1):
                stronglypositive += 1
            elif (analysis.sentiment.polarity > -0.3 and analysis.sentiment.polarity <= 0.00):
                negative += 1
        ...
        if (polarity == 0):
            ...
            print("Positive")
        elif (polarity > 0.3 and polarity <= 1):
            print("Strongly Positive")
        elif (polarity > -0.3 and polarity <= 0):
            print("Negative")
        elif (polarity > -1 and polarity <= -0.3):
